...
function CurrentSubscriptionDetail({modalInfo, setModalInfo}) {
    ...
    <div className='col-12 col-md-12 col-xl-9'>
      <div className='card bg-default-light t-relative border-0 t-py-3 mb-4'>
        <div className='border-0 bg-none t-pl-4'>
          <h5 className=' text-primary-color  t-text-2xl t-font-bold mt-3'>Your Subscription</h5>
        </div>
        <div className='p-3'>
            ...
            <div className='t-bg-blue-200 t-rounded-md t-p-4'>
              <div className='row'>
                <div className='col mb-3'>
                  <h3 className='fw-bold'>{billingInfo?.plan}</h3>
                  <p className='t-text-lg'>You're on the {billingInfo?.plan} plan.</p>
                </div>
        ...
        <div className='card-footer border-0 bg-none'>
          <p className='text-center t-text-lg mb-3'>
            ...
            <a href='/crafted/pages/plans' className='t-text-primary t-font-semibold'>
              View all plans
            </a>
          </p>
        </div>
        {!isTrialValid && !billingInfo?.appliedToCancel && (
