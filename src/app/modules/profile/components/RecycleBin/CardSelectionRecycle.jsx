...
import {LIST_DATA, QR_SORT, QR_STATUS, QR_TYPE} from '../../../../../mock'
...
import {
  ...
  DropdownCheckbox,
  Search,
} from '../../../../../_metronic/partials/qrComponents'
      ...
      <div className='t-flex t-flex-col gap-3 t-text-t1 t-h-full'>
        {qrsInfo?.qrs?.length > 0 ? (
          qrsInfo?.qrs?.map((card, index) => (
            <div
              key={card._id}
              className=' t-bg-white min-h-[200px]'
            >
              <div className=' t-flex t-flex-row t-items-center t-justify-between t-w-full t-text-[14px] xl:t-text-[16px] t-shadow-md t-rounded-xl'>
