...
import MyProfile from 'app/modules/accounts/components/MyProfile'
  ...
  return (
    <Routes>
      <Route element={<MasterLayout />}>
        ...
        />
        <Route
          path='apps/admin/subscriptions/details'
          element={
            <SuspensedView>
              <SubscriptionDetails />
            </SuspensedView>
        ...
        />
        <Route
          path='apps/admin/clients/details'
          element={
            <SuspensedView>
              <ClientDetails />
            </SuspensedView>
